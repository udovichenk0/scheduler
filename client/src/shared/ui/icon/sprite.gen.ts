  ...
  defineSprite("common", [
    defineSpriteAsset(
      [
        ...
        defineSpriteSymbol(["arrow"], [512, "0 0 1024 1024"]),
        defineSpriteSymbol(["bell"], [24]),
        defineSpriteSymbol(["calendar-due-date"], [24]),
        defineSpriteSymbol(["calendar-plus"], [24]),
        defineSpriteSymbol(["calendar-start-date"], [24]),
        defineSpriteSymbol(["calendar"], [20, "0 0 16 16"]),
        defineSpriteSymbol(["cancel"], [32, "0 0 24 24"]),
        defineSpriteSymbol(["check"], [24]),
        defineSpriteSymbol(["circle-done"], [24]),
        defineSpriteSymbol(["circle-dot"], [24]),
        defineSpriteSymbol(["circle"], [24]),
        defineSpriteSymbol(["cloud"], [317.17]),
        defineSpriteSymbol(["cornder-down-left"], [24]),
        defineSpriteSymbol(["cross-arrows"], [24]),
        defineSpriteSymbol(["done"], [122.877, 101.052]),
        defineSpriteSymbol(["eye-closed"], [24]),
        defineSpriteSymbol(["eye-opened"], [24]),
        defineSpriteSymbol(["filled-star"], [473.486]),
        defineSpriteSymbol(["flag"], [24]),
        defineSpriteSymbol(["inbox"], [20, "0 0 512 512"]),
        defineSpriteSymbol(["list"], [24]),
        defineSpriteSymbol(["loader"], [24]),
        defineSpriteSymbol(["mail"], [122.88, 88.86]),
        defineSpriteSymbol(["note"], [512, "0 0 256 256"]),
        defineSpriteSymbol(["outlined-star"], [20, "0 -0.5 21 21"]),
        defineSpriteSymbol(["palette"], [496]),
        defineSpriteSymbol(["plus"], [18, "0 0 24 24"]),
        defineSpriteSymbol(["reset"], [24]),
        defineSpriteSymbol(["settings"], [16]),
        defineSpriteSymbol(["timer"], [24]),
        defineSpriteSymbol(["trash-can"], [512, "0 0 32 32"]),
        defineSpriteSymbol(["upcoming"], [361.77]),
        defineSpriteSymbol(["user-plus"], [24]),
        defineSpriteSymbol(["user"], [24]),
        defineSpriteSymbol(["x"], [32, "0 0 24 24"]),
      ],
  ...
  defineSprite("editor", [
    defineSpriteAsset(
      [
        ...
        defineSpriteSymbol(["heading-1"], [24]),
        defineSpriteSymbol(["heading-2"], [24]),
        defineSpriteSymbol(["heading-3"], [24]),
        defineSpriteSymbol(["heading-4"], [24]),
        defineSpriteSymbol(["italic"], [24]),
        defineSpriteSymbol(["strikethrough"], [24]),
        defineSpriteSymbol(["text-align-center"], [24]),
        defineSpriteSymbol(["text-align-end"], [24]),
        defineSpriteSymbol(["text-align-justify"], [24]),
        defineSpriteSymbol(["text-align-start"], [24]),
        defineSpriteSymbol(["text"], [24]),
        defineSpriteSymbol(["underline"], [24]),
      ],
      defineExternalAssetMeta("editor.svg"),
    ),
  ]),
  defineSprite("sort", [
    defineSpriteAsset(
      [
        defineSpriteSymbol(["alph-asc"], [24]),
        defineSpriteSymbol(["alph-desc"], [24]),
        defineSpriteSymbol(["date-created-asc"], [24]),
        defineSpriteSymbol(["time-asc"], [24]),
        defineSpriteSymbol(["time-desc"], [24]),
      ],
      defineExternalAssetMeta("sort.svg"),
    ),
  ]),
])
...
export type SpritesMeta = {
  ...
  editor:
    ...
    | "text"
    | "underline"
  sort: "alph-asc" | "alph-desc" | "date-created-asc" | "time-asc" | "time-desc"
}
