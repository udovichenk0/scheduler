...
export const postAuthSigninBody = zod.object({
  "email": zod.string().email().min(postAuthSigninBodyEmailMin).describe('Email address'),
  "password": zod.string()
})
...
export const postAuthSigninResponse = zod.object({
  "id": zod.string().uuid(),
  "email": zod.string().email().min(postAuthSigninResponseEmailMin).describe('Email address'),
...
export const postAuthSignupBody = zod.object({
  "email": zod.string().email().min(postAuthSignupBodyEmailMin).describe('Email address'),
  "password": zod.string()
})
...
export const postAuthSignupResponse = zod.object({
  "id": zod.string().uuid(),
  "email": zod.string().email().min(postAuthSignupResponseEmailMin).describe('Email address'),
  "verified": zod.boolean()
})
...
export const getAuthSessionResponse = zod.object({
  "id": zod.string().uuid(),
  "email": zod.string().email().min(getAuthSessionResponseEmailMin).describe('Email address'),
  "verified": zod.boolean()
})
...
export const postAuthResendBody = zod.object({
  "email": zod.string().email().min(postAuthResendBodyEmailMin).describe('Email address'),
  "userId": zod.string().uuid()
})
...
export const patchTasksIdPriorityParams = zod.object({
  "id": zod.string().uuid()
})

export const patchTasksIdPriorityBody = zod.object({
  "priority": zod.enum(['none', 'low', 'normal', 'high', 'urgent'])
})
