...
var LinkView = function LinkView(props, ref) {
  ...
  if (typeof props.to === "string") {
    return /*#__PURE__*/jsx(NormalLink, _objectSpread2(_objectSpread2({
      ref: ref,
      href: props.to
    }, linkProps), {}, {
  ...
  return /*#__PURE__*/jsx(RouteLink, _objectSpread2({
    ref: ref
  }, props));
};

var NormalLink = /*#__PURE__*/forwardRef(function (props, ref) {
  return /*#__PURE__*/jsx("a", _objectSpread2({
    ref: ref,
...
var RouteLinkView = function RouteLinkView(props, ref) {
  ...
  var isOpened = useStore(routeObj.route.$isOpened);
  var navigate = useEvent(to.navigate);
  var href = buildPath({
...
var RouteLink = /*#__PURE__*/forwardRef(RouteLinkView);
var Link = /*#__PURE__*/forwardRef(LinkView);

function useIsOpened(route) {
  return Array.isArray(route) ? route.map(function (route) {
    return useStore(route.$isOpened);
  }).some(Boolean) : useStore(route.$isOpened);
}
...
function createRouteView(config) {
  return function (props) {
    ...
    if (isOpened) {
      ...
      return /*#__PURE__*/jsx(View, _objectSpread2({}, props));
    }

    if (mergedConfig.otherwise) {
      var Otherwise = mergedConfig.otherwise;
      return /*#__PURE__*/jsx(Otherwise, _objectSpread2({}, props));
    }
...
export { Link, Route, RouterContext, RouterProvider, createRouteView, createRoutesView, useLink, useRouter };
