...
function e(e2, t, n3, r2) {
  let o = [Te.run({ fn: (e3) => t(e3) })];
  if (r2 && o.unshift(r2), n3) {
    let t2 = n({ node: o }), r3 = e2.graphite.id, u2 = n3.additionalLinks, s3 = u2[r3] || [];
    return u2[r3] = s3, s3.push(t2), () => {
      let e3 = s3.indexOf(t2);
      -1 !== e3 && s3.splice(e3, 1), bt(t2);
    };
  }
  {
    let t2 = n({ node: o, parent: [e2], family: { owners: e2 } });
    return () => {
      bt(t2);
    };
  }
...
function n2(t, n3) {
  ne.store(t) || R("expect useStore argument to be a store");
  let r2 = import_react.default.useCallback((r3) => e(t, r3, n3), [t, n3]), o = import_react.default.useCallback(() => U(t, n3), [t, n3]);
  return O(r2, o, o);
}
function s2(e2) {
  let t = import_react.default.useContext(V);
  return e2 && !t && R("No scope found, consider adding <Provider> to app root"), t;
}
function l(e2, t) {
  return ((e3, t2) => {
    if (!t2)
    ...
    return import_react.default.useMemo(() => {
      if (ne.unit(e3))
        return N(e3, { scope: t2 });
      let n4 = Array.isArray(e3) ? [] : {};
      for (let r2 in e3)
        n4[r2] = N(e3[r2], { scope: t2 });
      return n4;
    }, [t2, ...Object.keys(n3), ...Object.values(n3)]);
  })(e2, s2(null == t ? void 0 : t.forceScope));
}
function a(e2, t) {
  return n2(e2, s2(null == t ? void 0 : t.forceScope));
}
var R = (e2) => {
  throw Error(e2);
};
...
var U = (e2, t) => t ? t.getState(e2) : e2.getState();
var V = import_react.default.createContext(null);
var { Provider: B } = V;

// node_modules/atomic-router-react/dist/atomic-router.esm.js
...
function clsx() {
  for (var e2, t, f = 0, n3 = ""; f < arguments.length; )
    (e2 = arguments[f++]) && (t = r(e2)) && (n3 && (n3 += " "), n3 += t);
  return n3;
}
...
var _excluded2 = ["to", "params", "query", "className", "activeClassName", "inactiveClassName", "onClick", "children"];
...
var NormalLink = (0, import_react2.forwardRef)(function(props, ref) {
...
var RouteLinkView = function RouteLinkView2(props, ref) {
  var to = props.to, params = props.params, query = props.query, className = props.className, activeClassName = props.activeClassName, inactiveClassName = props.inactiveClassName, _onClick = props.onClick, children = props.children, linkProps = _objectWithoutPropertiesLoose(props, _excluded2);
  ...
  var isOpened = a(routeObj.route.$isOpened);
  var navigate = l(to.navigate);
  var href = s({
...
var RouteLink = (0, import_react2.forwardRef)(RouteLinkView);
var Link = (0, import_react2.forwardRef)(LinkView);
function useIsOpened(route) {
  return Array.isArray(route) ? route.map(function(route2) {
    return a(route2.$isOpened);
  }).some(Boolean) : a(route.$isOpened);
}
function Route(_ref) {
