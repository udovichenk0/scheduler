...
function n2(t2, n3) {
  ...
  let r2 = import_react.default.useCallback((r3) => e(t2, r3, n3), [t2, n3]), o2 = import_react.default.useCallback(() => U(t2, n3), [t2, n3]);
  return O(r2, o2, o2);
}
function r(t2, n3) {
  ...
  let u3 = Array.isArray(o2), s2 = import_react.default.useRef({ stale: 1, justSubscribed: 0, scope: n3 }), [l2, a2, i3] = import_react.default.useMemo(() => {
    s2.current.stale = 1;
    let e2 = Array.isArray(o2) ? [] : {}, t3 = [], r3 = [];
    for (let u4 in o2) {
      let s3 = o2[u4];
      ne.unit(s3) || R("expect useUnit argument to be a unit"), ne.event(s3) || ne.effect(s3) ? e2[u4] = n3 ? N(s3, { scope: n3 }) : s3 : (e2[u4] = null, t3.push(u4), r3.push(s3));
    }
    return [e2, t3, r3];
  }, [s2, n3, ...Object.keys(o2), ...Object.values(o2)]), c2 = import_react.default.useRef({ value: l2, storeKeys: a2 }), f2 = import_react.default.useCallback((t3) => {
    let r3 = s2.current;
    r3.justSubscribed = 1;
    let o3 = () => {
    ...
    let e2, t3 = c2.current, o3 = s2.current, f3 = 0, p4 = t3.value, d2 = t3.storeKeys, m3 = n3 !== o3.scope;
    if (o3.stale || o3.justSubscribed || m3) {
      f3 = !o3.justSubscribed || m3, e2 = u3 ? [...l2] : { ...l2 }, d2.length !== a2.length && (f3 = 1);
      for (let t4 = 0; t4 < a2.length; t4++) {
        let r3 = U(i3[t4], n3), o4 = a2[t4];
        f3 || (f3 = d2.includes(o4) ? p4[o4] !== r3 : 1), e2[o4] = r3;
      }
    }
    return f3 && (t3.value = e2), t3.storeKeys = a2, o3.stale = 0, o3.justSubscribed = !f3, o3.scope = n3, r2 ? t3.value.unit : t3.value;
  }, [f2, i3, n3, c2, s2]);
  return O(f2, p3, p3);
}
function o([t2, n3], r2) {
  let o2, u3, s2, l2, a2 = K;
  n3 ? (o2 = n3, s2 = t2, l2 = []) : { fn: o2, store: s2, keys: l2, defaultValue: u3, updateFilter: a2 = K } = t2, ne.store(s2) || R("useStoreMap expects a store"), Array.isArray(l2) || R("useStoreMap expects an array as keys"), "function" != typeof o2 && R("useStoreMap expects a function");
  let i3 = import_react.default.useCallback((t3) => e(s2, t3, r2), [s2, r2]), c2 = import_react.default.useCallback(() => U(s2, r2), [s2, r2]), f2 = import_react.default.useRef(), p3 = import_react.default.useRef(), d2 = import_react.default.useRef(l2);
...
use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-PE6F2CJP.js.map
